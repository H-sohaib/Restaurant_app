<x-home-layout>
    ...
    <!-- Main Hero Content -->
    <div class="container max-w-lg px-4 py-32 pt-72 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
                    ...
                    @if ($menu->special)
                        <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                            <img class="w-full h-48"
                                src="{{ asset('storage/' . str_replace('public/', '', $menu->image_path)) }}"
                                alt="Image" />
                            <div class="px-6 py-4">
                                <div class="flex mb-2">
                                    <span
        ...
        <div class="container grid gap-4 mx-auto lg:grid-cols-3">
            ...
            @for ($i = 0; $i < $limit; $i++)
                <div class="w-full rounded">
                    <img src="{{ asset('storage/' . str_replace('public/', '', $menus[$i]->image_path)) }}"
    ...
    <footer class="bg-gray-800 border-t border-gray-200">
        <div class="container flex flex-wrap items-center justify-center px-4 py-8 mx-auto lg:justify-between">
            ...
            <div class="flex justify-center mt-4 lg:mt-0">
                ...
                <a href="https://www.linkedin.com/feed/update/urn:li:activity:7033442785353465856/" class="ml-3">
